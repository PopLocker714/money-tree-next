              ...
              <Column align="center">
                ...
                <Text className="mb-[16px] text-gray-500">
                  ...
                  <Link
                    ...
                    href={host === "localhost" ? `http://${host}:${port}/payment` : `https://${host}/payment`}
                  >
                    здесь
                  </Link>
                </Text>
                <Text className="mb-[16px] text-gray-500">
                  ...
                  <Link className="text-indigo-600" href={host === "localhost" ? `http://${host}:${port}/order` : `https://${host}/order`}>
                    здесь
                  </Link>
                </Text>
                <Button
                  className="box-border w-full rounded-[8px] bg-indigo-600 px-[12px] py-[12px] text-center font-semibold text-white"
                  href={host === "localhost" ? `http://${host}:${port}` : `https://${host}`}
                >
                  На главную
                </Button>
              </Column>
