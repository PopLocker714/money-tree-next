...
export default async function Payment() {
  return (
    <section className="container py-10">
      ...
      <p className="mb-1">
        Индивидуальный предприниматель Панюков Дмитрий Николаевич
      </p>

      <p className="mb-4">
        <strong>ИНН:</strong> 711501770103
      </p>

      <h3 className="text-xl mb-2">Банковские счета</h3>
      <p className="mb-1">
        <strong>Расчётный счёт:</strong> 40802810900007806397 в АО «ТБанк»
      </p>
      <p className="mb-1">
        <strong>БИК:</strong> 044525974
      </p>
      <p className="mb-4">
        <strong>Корреспондентский счёт:</strong> 30101810145250000974
      </p>
